<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
    ...
    <span class="navbar-text">
      <a href="form_usuario.php?id=<?= $_SESSION['id_usuario'] ?>"><strong ><?= $_SESSION['nome'] ?></strong>
            <img src="/assets/img/usuarios/<?= ($_SESSION['imagem'] != '' ? $_SESSION['imagem'] : 'usuario.png' ) ?>" class="rounded-circle user-img-menu"></a>
